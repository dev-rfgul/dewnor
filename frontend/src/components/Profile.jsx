...
//     const [orderedQuantity, setOrderQuantity] = useState(1)
...
//             // Optionally, log the updated cart or handle further actions like re-rendering the UI
//             console.log(cart);
//         }
//     };
...
//                                                     -
//                                                 </button>
//                                                 <span className="text-lg font-semibold">{product.qunatity}</span>
//                                                 <button
